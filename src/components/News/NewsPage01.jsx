    ...
    <section className="overflow-hidden">
      <div className="my-[10rem] w-full h-[30.7rem] 3xl:h-[38.8rem] relative flex justify-center text-center 2lg:text-start 2lg:justify-start items-center bg-[#FAF9F5] px-[6rem] 3xl:px-[14rem]">
        <div className=" relative hidden 2lg:block 2lg:absolute 2xl:right-0 -right-[3vw] 3xl:right-5 top-0">
          <div className="absolute hidden 2lg:block w-[105rem] top-[11.3rem] -left-[34rem]">
            <Image
          ...
          <div className="absolute hidden 2lg:block w-[105rem] h-[105rem] -top-[2.5rem] -left-[40.3rem]">
            <Image
          ...
          <div className="absolute w-[15.5rem] h-[15.5rem] top-[3.8rem] right-[8rem]">
            <Image
          ...
          <div className="absolute w-[6.5rem] h-[6.5rem] top-[2.5rem] right-[11.2rem]">
            <Image
          ...
          <div className="absolute transform 2lg:transform-none -translate-x-1/2 -translate-y-1/2 w-[11.5rem] h-[11.5rem] top-[23rem] right-[42rem]">
            <Image
          ...
          <div className="absolute w-[27rem] h-[27rem] -top-[1rem] right-[25rem]">
            <Image
