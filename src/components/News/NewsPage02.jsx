    ...
    <section className="overflow-hidden">
      <div className="my-[2.5rem] mb-[10rem] w-full h-[30.7rem] 3xl:h-[38.8rem] relative flex justify-center text-center 2lg:text-start 2lg:justify-end items-center px-[2rem] 3xl:px-[14rem]">
        <div className=" relative hidden 2lg:block flex-1">
          <figure className="absolute hidden 2lg:block w-[105rem] top-[2rem] left-[4rem]">
            <Image
          ...
          <figure className="absolute hidden 2lg:block w-[105rem] h-[105rem] -top-[14.8rem] left-[12rem]">
            <Image
          ...
          <figure className="absolute w-[24rem] h-[24rem] -top-[7rem] left-[19rem]">
            <Image
          ...
          <figure className="absolute w-[13rem] h-[13rem] top-[7.5rem] left-[20rem]">
            <Image
          ...
          <figure className="absolute w-[19rem] h-[19rem] -top-[14rem] left-6">
            <Image
        ...
        <div className="flex 2lg:flex-1 flex-col gap-[42px] relative 2lg:ml-[10rem]">
          <figure className="absolute hidden 2lg:block w-[15rem] h-[15rem] top-[14rem] left-[16rem]">
            <Image
          ...
          <article className="flex flex-col leading-1">
